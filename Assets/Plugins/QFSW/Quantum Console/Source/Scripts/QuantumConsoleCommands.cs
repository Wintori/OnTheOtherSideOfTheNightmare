...
namespace QFSW.QC
{
    public static partial class QuantumConsoleProcessor
    {
        ...
        private const string helpStr = "Welcome to Console! In order to see specific help about any specific command, " +
        ...
        [Command("help", "Shows a basic help guide for Console")]
        ...
        [CommandDescription("Generates a list of all commands currently loaded by the Console Processor")]
        [Command("commands")]
